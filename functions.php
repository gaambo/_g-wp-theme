...
define('VANILLA_VERSION', '0.1.0');
define('VANILLA_DIR', \plugin_dir_path(__FILE__));

require_once VANILLA_DIR . 'includes/admin.php';
require_once VANILLA_DIR . 'includes/assets.php';
    ...
    public function registerWidgetAreas()
    {
        \register_sidebar(
            array(
                ...
                'id'            => 'sidebar-1',
                'description'   => esc_html__('Add widgets here.', 'vanilla'),
